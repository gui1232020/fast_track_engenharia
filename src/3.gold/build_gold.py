...
from sla_calculation_gold import (
...
silver_issues_path = dir.parent.parent / "data" / "silver_layer" / "transform_silver.parquet"
silver_calendar_path = dir.parent.parent / "data" / "silver_layer" / "silver_holidays.parquet"
...
df = df[df["issue_status"].isin(["Done", "Resolved"])].copy()
...
#
out_path = dir.parent.parent / "data" / "gold_layer"
